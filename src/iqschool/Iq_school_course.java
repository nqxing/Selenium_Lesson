...
public class Iq_school_course {
	...
	static String subject [] = new String[]  
			{"数学","数学","数学"};  // *输入要新建的学科名，需要新建几门学科就往数组里添加几门，学科名字不可重复（每次运行脚本前必须修改）
...
//	}; 
	...
	{"课程yi","课程er",},
	{"课程san","课程si",},
	{"课程wu","课程liu",},// *输入对应学科下的课程名，该行对应上面第一门学科，需要新建几门课程就往数组里添加几门，课程名字可重复,
};
	...
	// 新建课程界面，输入年级范围
	static String classbegin = "八年级";     static String classfinish = "八年级";
	// 添加到年级课程池，选择年级，班级数量，班级上限人数
	static String grade = "八年级";    static String classnum = "2";  static String studentmax = "50";
	...
	public static void newDisciplineCourse() throws Exception{
        ...
        desiredMenu4.click();  
 		...
 		driver.findElement(By.xpath("//*/input[@placeholder='请输入课程名称']")).sendKeys(course[j][i]);
